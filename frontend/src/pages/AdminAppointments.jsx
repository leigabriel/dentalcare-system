      ...
      <aside className="w-20 bg-blue-900 text-gray-300 p-3 flex flex-col items-center justify-between shadow-2xl sticky top-0 h-screen z-20">
        <div>
          ...
          <nav className="space-y-4">
            <Link to="/admin/dashboard" title="Dashboard" className="flex items-center justify-center h-12 w-12 rounded-full text-gray-400 hover:bg-blue-600 hover:text-white relative group">
            ...
            <Link to="/admin/appointments" title="Appointments" className="flex items-center justify-center h-12 w-12 rounded-full bg-blue-500 text-white shadow-md relative group">
                        ...
                        <td className="px-3 py-4 text-sm space-x-2 whitespace-nowrap">
                          {app.status === 'pending' && (
                            <>
                              ...
                              <button onClick={() => handleCancel(app.id)} className="text-red-600 hover:text-red-800 font-medium">Cancel</button>
