                                        ...
                                        >
                                            ...
                                            <div className="flex items-start gap-4">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <h3 className="font-bold text-lg text-gray-800 mb-2 truncate">{service.name}</h3>
                                    ...
                                    {doctors.map((doctor) => (
                                        ...
                                        >
                                            ...
                                            <div className="flex items-start gap-4">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <h4 className="text-xl font-bold text-gray-800 mb-1">Dr. {doctor.first_name} {doctor.last_name}</h4>
                                                    <div className="inline-flex items-center px-3 py-1 rounded-full bg-indigo-500/30 border border-indigo-400/50">
