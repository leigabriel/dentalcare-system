      ...
      <div className="flex flex-col md:flex-row w-full max-w-5xl bg-white rounded-2xl overflow-hidden shadow-2xl border-4 border-gray-200 mx-4">
        ...
        <div className="relative flex flex-col justify-between text-white p-10 md:w-1/2 rounded-2xl md:rounded-none overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col justify-between h-full">
            <div>
              <p className="text-lg opacity-80 font-semibold mb-2">DENTALCARE</p>
              <h1 className="text-4xl font-extrabold leading-snug">We Care About Your Teeth Health</h1>
            </div>
        ...
        <div className="md:w-1/2 w-full p-8 flex flex-col justify-center">
          <h1 className="text-3xl font-extrabold text-gray-900 mb-1">Get Started Now</h1>
          <p className="text-gray-500 text-sm mb-6">Please log in to your account to continue.</p>
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center space-x-2">
                ...
                <span className="text-gray-600">
                  I agree to the <a href="#" className="text-blue-600 hover:underline">Terms & Privacy</a>
                </span>
              </label>
