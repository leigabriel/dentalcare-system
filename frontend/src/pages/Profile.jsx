            ...
            <div className="max-w-8xl bg-blue-900 border-4 border-white rounded-2xl p-8 mx-auto space-y-6 w-full">
                ...
                <header className="mb-6 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 bg-white shadow-sm rounded-2xl p-6 border">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-extrabold text-slate-900">{profile?.first_name} {profile?.last_name}</h1>
                            <p className="bg-blue-600 p-1 px-4 rounded-2xl text-sm text-white">
                                @{profile?.email?.split('@')[0]} • <span className="text-xs text-gray-300">Member since {new Date().toLocaleDateString('en-US', { month: 'short', year: 'numeric' })}</span>
                            </p>
                        </div>
                    </div>
                            ...
                            {editing ? (
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <p className="mt-1 text-slate-900">{profile?.first_name} {profile?.last_name}</p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-slate-900">{profile?.phone || 'Not provided'}</p>
                                    </div>
                                    <div>
