...
class Service {
    ...
    static async create(serviceData) {
        const sql = 'INSERT INTO services (name, description, price, duration_mins, created_at) VALUES (?, ?, ?, ?, NOW())';
        const params = [
            serviceData.name,
    ...
    static async update(id, serviceData) {
        const sql = 'UPDATE services SET name = ?, description = ?, price = ?, duration_mins = ? WHERE id = ?';
        const params = [
            serviceData.name,
            serviceData.description,
            serviceData.price,
